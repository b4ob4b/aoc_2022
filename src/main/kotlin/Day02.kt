...
fun main() {
    Day02(IO.TYPE.SAMPLE).test(15, 12)
    Day02().solve()
}

class Day02(inputType: IO.TYPE = IO.TYPE.INPUT) : Day("Rock Paper Scissors", inputType = inputType) {
    ...
    private val games = input.splitLines()
